...
ENV SCHROEDINGER_CDN_REGION "$SCHROEDINGER_CDN_REGION"

WORKDIR /app

COPY --from=build /app/build /app/

RUN aws s3 cp /app s3://${SCHROEDINGER_CDN_STORAGE}/ --endpoint-url https://s3-${SCHROEDINGER_CDN_REGION}.amazonaws.com --recursive --acl public-read
